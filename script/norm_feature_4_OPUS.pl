...
###################################################################
  if (@ARGV != 3)
    { # @ARGV used in scalar context = number of args
	  ...
	  print "perl $PROGRAM_NAME dir_sequence(*.fasta) dir_not_normed_dfire_score(*.OPUS_PSP_score) dir_output\n";
	  
	  print "For example:\n\n";
          print "perl $0 ../format_data/original_data/sequences ../calculated_scores/feature_8_OPUS_predictions ../normed_scores/predictions/feature_8_OPUS_predictions_norm\n";
          print "\nperl $0 ../format_data/original_data/sequences ../Validation/1_calculated_scores/feature_8_OPUS_casp11_stage1 ../Validation/2_normed_scores/casp11_stage1/feature_8_OPUS_casp11_stage1_norm\n";
          print "perl $0 ../format_data/original_data/sequences ../Validation/1_calculated_scores/feature_8_OPUS_casp11_stage2 ../Validation/2_normed_scores/casp11_stage2/feature_8_OPUS_casp11_stage2_norm\n";
	  exit(0);
	}
